...
<head>
    <meta charset="utf-8"/>
    <title>Rafeeq | Vehicle models</title>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add new vehicle model</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-form__group">
                                <label for="exampleInputEmail1" class="pb-1 mb-0">Vehicle model</label>
                                <input required type="text" class="form-control m-input m-input--square" id="city"  placeholder="Vehicle model">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group m-form__group">
                                <label for="exampleInputEmail1" class="pb-1 mb-0">Seat number</label>
                                <input required type="text" class="form-control m-input m-input--square" id="city"  placeholder="7">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-sm-12 pt-1 pb-1">Holographic number</label>
                                <div class="col-sm-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label col-sm-12 pt-1 pb-1">Holographic type</label>
                                <div class="col-sm-12">
                                    <select required class="form-control m-bootstrap-select m_selectpicker">
...
<div class="modal fade" id="m_modal_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <form action="#">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Edit vehicle model</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<div class="modal fade" id="m_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <form action="#">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Delete vehicle model</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group m-form__group">
                        <p>
                            are you want delete this model?
                        </p>
                    </div>
                </div>
                <div class="modal-footer">
