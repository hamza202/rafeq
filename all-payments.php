                        ...
                        <div class="table-responsive-xl">
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                <tr>
                                    ...
                                    <td>To</td>
                                    <td>Date</td>
                                    <td><span class="m-badge  m-badge--success m-badge--wide">Payment done</span>
                                    </td>
                                    <td>
                                     <span class="dropdown user-option">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left user-option">
                                             <a class="dropdown-item" href="#m_modal_6" data-toggle="modal"
                                                data-target="#m_modal_6">
                                                   <i class="fas fa-dollar-sign pl-2"></i> Transformation</a>
                                            <a class="dropdown-item" href="payments-details.php">
                                ...
                                <tr>
                                    ...
                                    <td>To</td>
                                    <td>Date</td>
                                    <td><span class="m-badge  m-badge--warning m-badge--wide">Payment in progress</span>
                                    </td>
                                    <td>
                                     <span class="dropdown user-option">
                                        <a href="#"
