        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper my-profile">
            ...
            <div class="m-subheader ">
                <div class="row align-items-center">
                    <div class="col-sm-4">
                        <h3 class="m-subheader__title ">Vehicle details</h3>
                    </div>
                                    ...
                                    <div class="m-portlet__head-title">
                                        <div class="m-portlet__head-label w-100 shadow-0">
                                            ...
                                            <a href="#m_modal_3" data-toggle="modal" data-target="#m_modal_3"
                                               class="btn btn-warning ml-2 m-btn m-btn--custom m-btn--icon d-inline-block text-center ">
                                                <span class="m-auto">
                            ...
                            <form class="m-form m-form--fit m-form--label-align-right">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group ">
                                        <ul id="imageGallery">
                                            <li data-thumb="assets/images/cars/1.jpg"
                                                data-src="assets/images/cars/1.jpg">
                                                <img src="assets/images/cars/1.jpg"/>
                                            </li>
                                            <li data-thumb="assets/images/cars/2.jpg"
                                                data-src="assets/images/cars/2.jpg">
                                                <img src="assets/images/cars/2.jpg"/>
                                            </li>
                                            <li data-thumb="assets/images/cars/3.jpg"
                                                data-src="assets/images/cars/3.jpg">
                                                <img src="assets/images/cars/3.jpg"/>
                                            </li>
                                            <li data-thumb="assets/images/cars/4.jpg"
                                                data-src="assets/images/cars/4.jpg">
                                                <img src="assets/images/cars/4.jpg"/>
                                            </li>
                                            <li data-thumb="assets/images/cars/5.jpg"
                                                data-src="assets/images/cars/5.jpg">
...
<div class="modal fade" id="m_modal_6" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <form action="#">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Check vehicle documentation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
